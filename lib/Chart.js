class Chart {
    constructor(sensor) {
        ...
        this._headerContainer.style.left = "74.6%";
        this._headerContainer.style.letterSpacing = "2px";
        this._headerContainer.style.zIndex = "9999999";
        this._headerContainer.style.height = "43px";
        this._headerContainer.style.lineHeight = "50px";
        this._headerContainer.style.fontSize = "14px";
        this._headerContainer.style.padding = "0 8px";

class Sensor {
    ...
    get format() {
        switch (this.name) {
            ...
            case "room2th_presence_state":
            case "room4nd_presence_state": return "enum_presence";
            case "room2th_air_state":
            case "room4nd_air_state": return "enum_airstate";
            case "room2th_light_state":
            case "room4nd_light_state":
            case "room2th_heater_state":
            case "room4nd_heater_state": return "enum_onoff";
            case "room2th_window_state":
            case "room4nd_window_state":
            case "room2th_blind_state":
            case "room4nd_blind_state": return "enum_openclosed";
        }
    }
